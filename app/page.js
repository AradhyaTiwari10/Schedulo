      ...
      <div className="flex flex-col items-center justify-between lg:flex-row gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Schedulo helps you manage your time effectively. Create events, set your availability, and let others book time with you seamlessly.
          </p>
          <Link href="/dashboard">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md aspect-square">
            <Image src="/poster.png" alt="Poster for Schedulo" layout="fill" objectFit="contain" />
          </div>
        </div>
      </div>
      <div className="mb-24">
